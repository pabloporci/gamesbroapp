  ...
  return (
    <div className="container fondo_azul">
      ...
      <ul className="nav d-flex align-items-center">
        ...
        <li className="nav-item">
          <Link className="nav-link link_header" to="/">Home</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link link_header" to="/">PlayStation</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link link_header" to="/">Nintendo</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link link_header" to="/">Contacto</Link>
        </li>
      </ul>
    </div >
  )
